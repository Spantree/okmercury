	...
	<body>
		<div id="wrapper" class="full lr-page span4 offset4">
			...
			<g:if test="${confirmation}">
				<div class="row-fluid">
					<div id="login-form">
						<h5>The user ${user} already exists. Confirm your OkMercury password to merge this social account.</h5>
						<h5>Not ${user}? <a href="/login/auth">Re-Login Here</a></h5>
						...
						<form method="post" action="">
							...
							<div class="actions">
								<button type="submit" class="btn span12">Merge ${provider} account!</button>
							</div>
						</form>
					</div>
				</div>
